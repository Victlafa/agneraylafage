...
namespace state
{
    ...
    ElementTab::ElementTab(TypeID type, size_t width, size_t height) {
        ...
        if (type == TypeID::CELL) {
            ...
            std::vector<unsigned int> li = {0, 0, 0, 0}; //liste des ordonnées des cellules speciales
            std::vector<unsigned int> lj = {0, 0, 0, 0}; //liste des absisses des cellules simples
